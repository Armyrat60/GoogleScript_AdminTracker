...
function onOpen() {
  ...
  ui.createMenu('⚙️ Admin Tracker (v' + VERSION + ')')
    ...
    .addSubMenu(ui.createMenu('🛠️ SETUP')
      ...
      .addItem('Update Config.gs (Optional)', 'updateConfigGuide'))
...
/**
 * Update Config.gs Guide - Shows users how to optionally update Config.gs
 * Preserves customizations by default, but gives option to update
 */
function updateConfigGuide() {
  var ui = SpreadsheetApp.getUi();
  
  var message = 
    'CONFIG.GS UPDATE GUIDE\n\n' +
    '⚠️ IMPORTANT: You do NOT need to update Config.gs!\n\n' +
    'Your current Config.gs works perfectly with v4.0.\n' +
    'Updating Config.gs will ERASE your customizations:\n\n' +
    '❌ Team Colors (TEAM_COLORS)\n' +
    '❌ Hours Color Ranges (COLOR_RANGES)\n' +
    '❌ Any other tweaks you made\n\n' +
    '✅ RECOMMENDED: Keep your current Config.gs\n\n' +
    '📝 Only update Config.gs if:\n' +
    '• You haven\'t customized it\n' +
    '• You want default colors back\n' +
    '• You\'re okay with re-customizing\n\n' +
    'Would you like instructions on how to:\n' +
    'A) Keep your Config.gs (recommended)\n' +
    'B) Update Config.gs (lose customizations)\n' +
    'C) Update Config.gs + preserve customizations';
  
  var result = ui.alert('Update Config.gs?', message, ui.ButtonSet.YES_NO_CANCEL);
  ...
  if (result === ui.Button.NO) {
    // Show how to keep current Config.gs
    ui.alert(
      'Keep Current Config.gs ✅',
      'Perfect! Your current Config.gs will work great.\n\n' +
      'To update to v4.0:\n' +
      '1. Extensions → Apps Script\n' +
      '2. REPLACE: AdminHoursTracker.gs with new version\n' +
      '3. KEEP: Config.gs (don\'t touch it!)\n' +
      '4. Save (Ctrl+S)\n' +
      '5. Run SETUP → Migrate Old Data\n\n' +
  ...
  if (result === ui.Button.YES) {
    // Show options for updating
    var choice = ui.alert(
      'How to Update Config.gs',
      'Choose your approach:\n\n' +
      'Option A: Simple Update (LOSE customizations)\n' +
      '• Replace Config.gs with new version\n' +
      '• Fast and simple\n' +
      '• Team colors reset to defaults\n\n' +
      'Option B: Update + Preserve Customizations\n' +
      '• Back up your TEAM_COLORS first\n' +
      '• Replace Config.gs\n' +
      '• Paste customizations back\n' +
      '• Takes 5 extra minutes\n\n' +
      'Press OK for Option A instructions\n' +
      'Press Cancel for Option B instructions',
      ui.ButtonSet.OK_CANCEL
    );
    ...
    if (choice === ui.Button.OK) {
      ...
      ui.alert(
        ...
        'STEPS:\n\n' +
        '1. Extensions → Apps Script\n' +
        '2. Click Config.gs in left sidebar\n' +
        '3. Select all (Ctrl+A)\n' +
        '4. Delete\n' +
        '5. Paste new v4.0 Config.gs\n' +
        '6. Save (Ctrl+S)\n\n' +
        '⚠️ WARNING: This erases your:\n' +
        '• Custom team colors\n' +
        '• Custom color ranges\n\n' +
        'You can re-customize them later by editing\n' +
        'TEAM_COLORS and COLOR_RANGES in Config.gs.',
        ui.ButtonSet.OK
      );
    } else {
      // Option B: Update + preserve
      ui.alert(
        'Option B: Update + Preserve (Part 1 of 2)',
        'STEP 1: Back up your customizations\n\n' +
        '1. Extensions → Apps Script\n' +
        '2. Click Config.gs in left sidebar\n' +
        '3. Scroll to TEAM_COLORS section\n' +
        '4. Copy entire TEAM_COLORS: { ... } object\n' +
        '5. Paste into a text file\n' +
        '6. Scroll to COLOR_RANGES section\n' +
        '7. Copy entire COLOR_RANGES: [ ... ] array\n' +
        '8. Paste into same text file\n' +
        '9. Save text file\n\n' +
        'Click OK when done backing up.',
        ui.ButtonSet.OK
      );
      
      ui.alert(
        'Option B: Update + Preserve (Part 2 of 2)',
        'STEP 2: Replace Config.gs\n\n' +
        '1. In Apps Script, select all Config.gs (Ctrl+A)\n' +
        '2. Delete\n' +
        '3. Paste new v4.0 Config.gs\n\n' +
        'STEP 3: Restore customizations\n\n' +
        '4. Scroll to TEAM_COLORS section\n' +
        '5. Replace it with your backed-up version\n' +
        '6. Scroll to COLOR_RANGES section\n' +
        '7. Replace it with your backed-up version\n' +
        '8. Save (Ctrl+S)\n\n' +
        '✅ Done! You now have:\n' +
        '• Latest Config.gs structure\n' +
