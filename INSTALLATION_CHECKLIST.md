...
### GitHub URLs (Already Set!)
- [x] **GitHub URLs are pre-configured** - No changes needed!
  - The script already points to: https://github.com/Armyrat60/GoogleScript_AdminTracker

### BattleMetrics Settings
- [ ] **Set BM_SERVER_ID** (line 26) to your server ID number
